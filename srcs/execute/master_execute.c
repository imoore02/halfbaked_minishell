...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/13 15:58:09 by isobelmoore       #+#    #+#             */
/*   Updated: 2022/12/13 16:50:31 by isobelmoore      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
int	execute(t_concept *info)
{
	int	return;

	reurn = prep_for_exec(info);
...
*	execute.
*/
static int	prep_for_exec(t_concept *info)
{
	if (!info || !data->cmd)
		return (EXIT_SUCCESS);
	if (!data->cmd->command)
